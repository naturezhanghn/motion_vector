...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/portable-ruby/2.6.3_2")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/Cellar/portable-ruby/2.6.3_2' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=tk,sdbm,gdbm,dbm' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' '--with-opt-dir=/usr/local/opt/portable-readline:/usr/local/opt/portable-libyaml:/usr/local/opt/portable-openssl' 'CC=cc' 'LDFLAGS=-Wl,-search_paths_first' 'CXX=c++'"
  ...
  CONFIG["RANLIB"] = ":"
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple LLVM version 7.0.2 (cc-700.1.81)\nTarget: x86_64-apple-darwin14.5.0\nThread model: posix"
